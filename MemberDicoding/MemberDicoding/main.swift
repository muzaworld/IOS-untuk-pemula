...
//  MemberDicoding
//
//  Created by Rifany Reza on 10/06/21.
...
let address = getInputString(message: "Masukkan alamat rumah kamu")
let school = getInputString(message: "Masukkan nama sekolah kamu / kampus kamu")
